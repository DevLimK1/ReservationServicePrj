...
public class DisplayInfoDto {
	...
	public DisplayInfoDto(int categoryId, String categoryName, String createDate, Integer displayInfoId, String email,
			String homepage, String modifyDate, String openingHours, String placeLot, String placeName,
			String placeStreet, String productContent, String productDescription, String productEvent,
			Integer productId, String telephone) {
		super();
