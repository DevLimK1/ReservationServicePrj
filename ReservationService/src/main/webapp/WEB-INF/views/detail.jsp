...
<body>
	<div id="container">
		<input type="hidden" value="${displayInfoId}" class="displayInfo">
		...
		<div class="ct main">
			<div>
					...
					<div class="event_info_box">
						...
						<div class="event_info">
							<div class="in_dsc">
								...
								<c:forEach var="item" items="${productPrices}"
									varStatus="status">
									<fmt:parseNumber value="${item.discountRate}" integerOnly="true" var="discountRate"/>
									<c:if test="${!status.last }">
									${item.priceTypeName}석 ${discountRate}%
									${comma}
									</c:if>
									<c:if test="${status.last}">
									${item.priceTypeName}석 ${discountRate}%
				...
				<div class="section_review_list">
					...
					<a class="btn_review_more" href="../review/${displayInfoId}"> <input
						type="hidden" name="displayInfoId" value="${displayInfoId}">
	...
	<script type="rv-template" id="slideItem">
	<li class="item" style="width: 414px;"><img alt=""
		class="img_thumb" src="/{{saveFileName}}"> <span
		class="img_bg"></span>
	...
	<script type="rv-template" id="pager">
						<div class="bg_pagination"></div>
						<div class="figure_pagination">
							<span class="num">{{position}}</span> 
							<span class="num off">/ <span>{{slideCount}}</span></span>
						</div>
	</script>
