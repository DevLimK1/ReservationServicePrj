...
<body>
			...
			<div class="section_visual">
				<div class="group_visual">
					<div class="container_visual">
						...
						<div>
							<div class="inner container_visual">
			...
			<div class="section_event_lst">
				...
				<div class="wrap_event_box">
					...
					<ul class="lst_event_box">
						<c:forEach items="${list}" var="list" begin="0" end="1">
							<li class="item"><a href="./detail/${list.displayInfoId}"
								class="item_book"> <input name="displayInfoId" type="hidden"
									value="${list.displayInfoId}">
									<div class="item_preview">
										<img alt="${list.productDescription}" class="img_thumb"
											src="/${list.productImageUrl}"> <span
											class="img_border"></span>
									</div>
									<div class="event_txt">
										<h4 class="event_txt_tit">
											<span>${list.productDescription}</span> <small class="sm">${list.placeName}</small>
										</h4>
										<p class="event_txt_dsc">${list.productContent}</p>
									</div>
							</a></li>
						</c:forEach>
					</ul>
					<ul class="lst_event_box">
						<c:forEach items="${list}" var="list" begin="2" end="3">
							<li class="item"><a href="./detail/${list.displayInfoId}"
								class="item_book"> <input name="displayInfoId" type="hidden"
									value="${list.displayInfoId}">
									<div class="item_preview">
					...
					<!-- 더보기 -->
					<div class="more" data-category="${id}" data-start="${start}">
						<button class="btn">
							<span>더보기</span>
						</button>
					</div>
	...
	<script type="rv-template" id="itemList">
    	<li class="item">
			<a href="./detail/{displayInfoId}" class="item_book">
									<input name="displayInfoId" type="hidden" value="{displayInfoId}">					
									<div class="item_preview">
										<img alt="{description}" class="img_thumb"
											src="/{saveFileName}"> <span class="img_border"></span>
									</div>
									<div class="event_txt">
										<h4 class="event_txt_tit">
											<span>{description}</span> <small class="sm">{placeName}</small>
										</h4>
	...
	<script type="rv-template" id="itemListCount">
		바로 예매 가능한 행사가 <span class="pink">{count}개</span> 있습니다
 	</script>
</body>
